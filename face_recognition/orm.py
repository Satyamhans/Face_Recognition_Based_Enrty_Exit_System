...
def register_face(enroll):
    ...
    while True:
        ...
        os.chdir("/home/satyam/Desktop/face_recognition-master")
        if ret:
        ...
        if process_this_frame and flag%4==0:
...
def recognize_face():
    video_capture = cv2.VideoCapture(0)
    connection = sqlite3.connect('/home/satyam/Desktop/face_recognition-master/face_recognition/proj_database.db')
